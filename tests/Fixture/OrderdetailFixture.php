...
class OrderdetailFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'proc_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'proc_id' => ['type' => 'index', 'columns' => ['proc_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'orderdetail_ibfk_1' => ['type' => 'foreign', 'columns' => ['proc_id'], 'references' => ['products', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
