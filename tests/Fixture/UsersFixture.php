...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['role', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-12 08:13:02',
                'modified' => '2018-11-12 08:13:02',
                'role_id' => 1
            ],
        ];
        parent::init();
