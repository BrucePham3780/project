				...
				<div class="slick3">
					<div class="item-slick3" data-thumb="/images/thumb-item-01.jpg">
						<div class="wrap-pic-w">
								<?=$this->Html->image($product->images)?>
						</div>
					</div>
...
<!-- <section class="relateproduct bgwhite p-t-45 p-b-138"> -->
	<div class="container">
		...
		<div class="wrap-slick2">
			<div class="slick2">
				<?php foreach ($product2 as $product3): ?>

					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<?=$this->Html->image($product3->images, array('max-wight'=>'200px', 'wight'=>'270px', 'height'=>'340px', 'max-height'=>'340px'))?>
							...
							<div class="block2-txt p-t-20" align="center">
								<a href="product-detail.html" class="block2-name dis-block s-text3 p-b-5">
									<?= $this->Html->link($this->Html->tag('',$product3->name),
										['controller' => 'customers','action' => 'product',$product3->id],
